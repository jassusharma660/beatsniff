...
function __construct($wid) {
    ...
    {   $ID = $this->widget_id;
        $this->data[$ID]['number_votes'] = 0;
        $this->data[$ID]['total_points'] = 0;
        $this->data[$ID]['dec_avg'] = 0;
        $this->data[$ID]['whole_avg'] = 0;
        $this->data[$ID]['number_votes'] = 0;
        $this->data[$ID]['total_points'] = 0;
        $this->data[$ID]['dec_avg'] = 0;
        $this->data[$ID]['whole_avg'] = 0;
...
public function vote() {
    ...
    if($this->data[$ID]) {
        ...
        switch($vote){
            case '1': $this->data[$ID]['one'] += 1;break;
            case '2': $this->data[$ID]['two'] += 1;break;
            case '3': $this->data[$ID]['three'] += 1;break;
            case '4': $this->data[$ID]['four'] += 1;break;
            case '5': $this->data[$ID]['five'] += 1;break;
        }
    }
    # Create a new one if it doesn't
        ...
        $this->data[$ID]['total_points'] = $vote;
        switch($vote){
            case '1': $this->data[$ID]['one'] = 1;
                        $this->data[$ID]['two'] = 0;
                        $this->data[$ID]['three'] = 0;
                        $this->data[$ID]['four'] = 0;
                        $this->data[$ID]['five'] = 0;break;
            case '2': $this->data[$ID]['two'] = 1;
                        $this->data[$ID]['one'] = 0;
                        $this->data[$ID]['three'] = 0;
                        $this->data[$ID]['four'] = 0;
                        $this->data[$ID]['five'] = 0;break;
            case '3': $this->data[$ID]['three'] = 1;
                        $this->data[$ID]['one'] = 0;
                        $this->data[$ID]['two'] = 0;
                        $this->data[$ID]['four'] = 0;
                        $this->data[$ID]['five'] = 0;break;
            case '4': $this->data[$ID]['four'] = 1;
                        $this->data[$ID]['one'] = 0;
                        $this->data[$ID]['two'] = 0;
                        $this->data[$ID]['three'] = 0;
                        $this->data[$ID]['five'] = 0;break;
            case '5': $this->data[$ID]['five'] = 1;
                        $this->data[$ID]['one'] = 0;
                        $this->data[$ID]['two'] = 0;
                        $this->data[$ID]['three'] = 0;
                        $this->data[$ID]['four'] = 0;break;
        }
    }
